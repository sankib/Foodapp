    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <thead class='thead-dark'>
                <tr>
                    ...
                    <th style="width: 14.28%">Item image</th>
        ...
        <?php 
            ...
            if(isset($_GET['edit'])){
                ...
                $currentItemImage=$data['itemImage'];
        ...
        <div class="row justify-content-center">
            <div class="shadow p-3 mb-5 bg-white rounded w-50">
                ...
                <form action="../server/restro.php" method="post">
                    ...
                    <div >
                        <label for="item name">item image: </label>
                        <input type="file" class="form-control" name="itemimage" value="<?php echo $currentItemName; ?>" required>
                    </div>
