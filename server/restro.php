...
if(isset($_POST['additem'])){
    ...
    if(count($errors)==0){
        //save items data
        $query= "insert into menu (itemName, itemImage, itemDetail , itemCost, itemType, restroId) values ('$itemname','$itemimage','$itemdetail','$itemcost','$itemtype','$restroid')";
...
if(isset($_POST['updateitem'])){
    ...
    if(count($errors)==0){
        //update item data
        $query= "update menu set itemName='$itemname',itemImage='$itemimage',itemDetail='$itemdetail' ,itemCost='$itemcost', itemType='$itemtype' where id='$itemid'";
        mysqli_query($conn,$query);
